"""
Application: votes_DecisionTree.py

Training Dataset: votes-train0.csv
    
Description: This application will create an X node decision tree. It uses the voting record 
dataset which will classify democrats and republicans. Will get different validation and 
training errors each run because uses kfold and builds a new tree each run. Hardcoded the 
best theta, which was found during cross validation.
