"""
Application: Haykin2_DecisionTree.py

Training Dataset: haykin2.csv
    
Description: This application will create an X node decision tree. It uses the synthetic
haykin2 dataset.  Will get different validation and training errors each run because uses 
kfold and builds a new tree each run.

How to Run: python Applications/Haykin2_DecisionTree.py (from root ML1050 directory)
"""
