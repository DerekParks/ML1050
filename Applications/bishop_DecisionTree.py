"""
Application: bishop_DecisionTree.py
...
dataset provided in Christopher Bishops text book.  Will get different validation and 
training errors each run because uses kfold and builds a new tree each run.

How to Run: python Applications/bishop_DecisionTree.py (from root ML1050 directory)
"""
...
def main():
    ...
    dataSet = TrainingSet('../Datasets/bishop_synthetic.csv')
