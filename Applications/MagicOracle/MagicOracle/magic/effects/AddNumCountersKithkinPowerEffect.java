...
public class AddNumCountersKithkinPowerEffect extends Effect{
	...
	public void executeEffect() {
		throw new RuntimeException("ERROR:  default executeEffect was " +
				"inappropriately called in AddNumCountersKithkinPowerEffect");
	}
	...
	public void executeEffect(Object theObject) {
		...
		{
			((CreatureCard)theObject).changePower(myCard.getNumCounters());
		}
