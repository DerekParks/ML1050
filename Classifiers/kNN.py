...
class kNN(Classifier):
    ...
    def classify(self, node):
        ...
        # Otherwise its Function or ZeroOne
            ...
            if(isinstance(kNearestNeighbors[0].label, int) or isinstance(kNearestNeighbors[0].label, float)):
              result = sum([x.label for x in kNearestNeighbors])
              return result/len(kNearestNeighbors)
